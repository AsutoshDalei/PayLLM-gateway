...
# Initialize the LLaMA 3.2 model with specific parameters
model = ChatOllama(model="llama3.2:latest", temperature=0)

# Setup conversation memory
memory = InMemoryChatMessageHistory(session_id="payment-session")

# Simulated database of service providers categorized by state and service type
serviceDB = {'odisha':
    {
        'electricity': ['OELE1', 'OELE2', 'OELE3'], 'gas': ['OGAS1', 'OGAS2', 'OGAS3', 'OGAS4'],
        'water': ['OWAT1', 'OWAT2']
    },
    'goa':
        {
